...
export default function Dashboard({ user, totalKapal, totalKegiatanKapal, charts }) {
      ...
      <Layout user={user}>
        <div className="mx-8">
          ...
          <div className="grid grid-cols-12 gap-3 w-full mt-5">
            <div className="border col-span-6 shadow-md px-4 py-5 rounded-md flex justify-between items-center">
              <div>
